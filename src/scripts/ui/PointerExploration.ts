                        ...
                        players: [
                            {
                                ...
                                player: false,
                                type: enemy.type,
                                spriteClass: enemy.spriteClass,
                                position: enemy.getPosition(),
                                direction: enemy.getDirection()
                            },
                            {
                                name: activePawn._name,
                                faction: 'human',
                                player: true,
                                type: activePawn.type,
                                spriteClass: activePawn.spriteClass,
                                position: this.game.spritesManager.getReal(activePawn).getPosition(),
                                direction: this.game.spritesManager.getReal(activePawn).getDirection()
                            }
                        ],
                        stage: layers,
