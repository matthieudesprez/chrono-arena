...
(function (TacticArena) {
    var StageManager = (function () {
        ...
        StageManager.prototype.clearHelp = function () {
            ...
            this.game.pointer.uiLastPosition = new TacticArena.Position(-1, -1);
        };
        ...
        StageManager.prototype.getPosition = function (absolutePosition) {
            return new TacticArena.Position(Math.floor(absolutePosition.x / this.game.worldGroup.scale.x / this.game.tileSize), Math.floor(absolutePosition.y / this.game.worldGroup.scale.y / this.game.tileSize));
        };
        return StageManager;
    }());
    ...
    (function (Entity) {
        ...
        (function (Skill) {
            var Walk = (function (_super) {
                ...
                Walk.prototype.onDeselect = function () {
                    this.cleanUI();
                };
    ...
    (function (Entity) {
        ...
        (function (Skill) {
            var Wind = (function (_super) {
                ...
                Wind.prototype.onOrder = function (position, direction) {
                    this.pawn.getProjectionOrReal(true).halfcast(direction);
                    this.state.orderManager.add(this.pawn, new TacticArena.Order.Wind(position, direction));
                };
                return Wind;
            }(TacticArena.Entity.Skill.LinearSkill));
            Skill.Wind = Wind;
    ...
    (function (UI) {
        var ActionMenu = (function () {
            function ActionMenu(game, pawn) {
                ...
                var avatar = this.game.make.sprite(37, 84, 'avatar-' + pawn.type);
                avatar.anchor.set(0, 1);
                var name = this.game.add.text(40, 5, pawn._name, {
                    font: '20px Iceland',
                    fill: '#ffffff',
                    boundsAlignH: 'left',
                    boundsAlignV: 'top',
            ...
            ActionMenu.prototype.disableConfirm = function () {
                this.confirmEnabled = false;
                this.buttonConfirmGroup.alpha = 0.5;
            };
            ActionMenu.prototype.enableCancel = function () {
                this.buttonCancelGroup.alpha = 1;
            };
            ActionMenu.prototype.disableCancel = function () {
            ...
            Dialog.prototype.createModal = function (options) {
                ...
                for (var i = 0; i < itemsArr.length; i += 1) {
                    ...
                    if (itemType === "text" || itemType === "bitmapText") {
                        ...
                        modalLabel = this.game.make.tileSprite(itemX, itemY, tileSpriteWidth, tileSpriteHeight, content, imageFrame);
                        modalLabel.scale.setTo(contentScale, contentScale);
                        ...
                        modalLabel = this.game.make.button(0, 0, atlasParent, callback, this, buttonHover, content, buttonActive, content);
                        modalLabel.scale.setTo(contentScale, contentScale);
        ...
        var TimelineMenu = (function () {
            ...
            TimelineMenu.prototype.init = function (steps_number) {
                ...
                return new Promise(function (resolve, reject) {
                    ...
                    var buttonPrevious = self.game.make.sprite(50, 33, 'button-square-previous');
                    ...
                    var buttonNext = self.game.make.sprite(_this.game.world.width - 85, 33, 'button-square-next');
        ...
        var TopMenu = (function () {
            function TopMenu(game) {
                ...
                this.game.pawns.forEach(function (pawn, index) {
                    ...
                    var frame = self.game.make.sprite(0, 0, 'avatar-frame');
                    frame.anchor.set(0.5);
                    var avatar = self.game.make.sprite(0, 0, 'avatar-' + pawn.type + '-small');
